...
#ifndef YY_YY_CONJ_TAB_H_INCLUDED
# define YY_YY_CONJ_TAB_H_INCLUDED
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_stmt = 41,                             // stmt
        S_com_stmt = 42,                         // com_stmt
        S_var_defs = 43,                         // var_defs
        S_var_def1 = 44,                         // var_def1
        S_exprs = 45,                            // exprs
        S_c_expr1 = 46,                          // c_expr1
        S_expr = 47                              // expr
      };
    };
...
#line 1787 "conj.tab.h"




#endif // !YY_YY_CONJ_TAB_H_INCLUDED
